 ...
 */
MapTo('angular-arch51/components/navigation')(NavigationV1Component, {isEmpty: NavigationV1IsEmptyFn});
MapTo('angular-arch51/components/separator')(SeparatorV1Component);

MapTo('angular-arch51/components/container')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});
MapTo('angular-arch51/components/experiencefragment')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});

MapTo('angular-arch51/components/download')(DownloadV1Component,{isEmpty: DownloadV1IsEmptyFn});
MapTo('angular-arch51/components/languagenavigation')(LanguageNavigationV1Component);
MapTo('angular-arch51/components/list')(ListV2Component, {isEmpty: ListV2IsEmptyFn});
MapTo('angular-arch51/components/breadcrumb')(BreadCrumbV2Component, {isEmpty: BreadCrumbV2IsEmptyFn});
MapTo('angular-arch51/components/button')(ButtonV1Component, {isEmpty: ButtonV1IsEmptyFn});
MapTo('angular-arch51/components/image')(ImageV2Component, {isEmpty: ImageV2IsEmptyFn});
MapTo('angular-arch51/components/title')(TitleV2Component, {isEmpty: TitleV2IsEmptyFn});

MapTo('angular-arch51/components/accordion')(AccordionV1Component);
MapTo('angular-arch51/components/tabs')(TabsV1Component);
...
LazyMapTo('angular-arch51/components/teaser')(TeaserV1Component);
...
LazyMapTo('angular-arch51/components/carousel')(CarouselV1Component);
...
LazyMapTo('angular-arch51/components/text')(LazyTextModule, TextEditConfig);